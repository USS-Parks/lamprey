...
- Read `DEVLOG.md` for detailed build history before making changes. Parity + Fluidity + Deep Research + Snip + Customize + Panels + Stall + Skill Import plans are now reference-only — there is no active plan at the moment.
