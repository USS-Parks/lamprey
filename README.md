...
|---|---|---:|---|
| **NSIS installer** | `Lamprey-0.1.22-x64.exe` | 178 MB | [Download .exe](https://github.com/USS-Parks/lamprey/releases/download/v0.1.22/Lamprey-0.1.22-x64.exe) |
| **Portable ZIP** | `Lamprey-0.1.22-x64.zip` | 225 MB | [Download .zip](https://github.com/USS-Parks/lamprey/releases/download/v0.1.22/Lamprey-0.1.22-x64.zip) |
...
1. **Download** the [v0.1.22 installer](https://github.com/USS-Parks/lamprey/releases/download/v0.1.22/Lamprey-0.1.22-x64.exe) and run it.
